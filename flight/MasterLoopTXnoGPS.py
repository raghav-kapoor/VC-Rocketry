...
"gps_lat": 11, "gps_lon": 12, "gps_alt": 13, "gps_spd": 14,
...
#    gpsp.start()
#    while True:
#        if ((gpsd.fix.latitude > 0.0) or (gpsd.fix.latitude < 0.0)) and (gpsd.fix.altitude > 0.0) and (type(gpsd.fix.speed) is float):
#	    print("GPS Locked")
#           break
#        else:
